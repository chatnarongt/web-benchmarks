...
import { createManyBody, createManyResponse } from './models/create-many.model';
import { createOneBody, createOneResponse } from './models/create-one.model';
...
import { updateManyBody, updateManyResponse } from './models/update-many.model';
import { updateOneBody, updateOneParams, updateOneResponse } from './models/update-one.model';
...
export const benchmarkController = new Elysia()
  ...
  .post(
    '/create-one',
    async ({ body }) => {
      return CreateOneUseCase.execute(body);
    },
    {
      body: createOneBody,
      response: {
        200: createOneResponse,
      },
      detail: {
        tags: ['Benchmark'],
  ...
  .post(
    '/create-many',
    async ({ body }) => {
      return CreateManyUseCase.execute(body);
    },
    {
      body: createManyBody,
      response: {
        200: createManyResponse,
      },
      detail: {
        tags: ['Benchmark'],
  ...
  .patch(
    '/update-one/:id',
    async ({ params, body }) => {
      return UpdateOneUseCase.execute(params, body);
    },
    {
      params: updateOneParams,
      body: updateOneBody,
      response: {
        200: updateOneResponse,
      },
      detail: {
        tags: ['Benchmark'],
  ...
  .put(
    '/update-many',
    async ({ body }) => {
      return UpdateManyUseCase.execute(body);
    },
    {
      body: updateManyBody,
      response: {
        200: updateManyResponse,
      },
      detail: {
        tags: ['Benchmark'],
